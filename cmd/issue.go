...
var (
	IssueNoPartition = Issue{
		...
		RefURL:      "https://docs.metal-stack.io/stable/installation/troubleshoot.html#no-partition",
	}
	IssueLivelinessDead = Issue{
		ShortName:   "liveliness-dead",
		Description: "the machine is not sending events anymore",
		RefURL:      "https://docs.metal-stack.io/stable/installation/troubleshoot.html#liveliness-dead",
	}
	IssueLivelinessUnknown = Issue{
		...
		RefURL:      "https://docs.metal-stack.io/stable/installation/troubleshoot.html#liveliness-unknown",
	}
	...
	IssueFailedMachineReclaim = Issue{
		...
		RefURL:      "https://docs.metal-stack.io/stable/installation/troubleshoot.html#failed-machine-reclaim",
	}
	IssueIncompleteCycles = Issue{
		...
		RefURL:      "https://docs.metal-stack.io/stable/installation/troubleshoot.html#incomplete-cycles",
	}
	IssueASNUniqueness = Issue{
		ShortName:   "asn-not-unique",
		Description: "The ASN is not unique (only impact on firewalls)",
		RefURL:      "https://docs.metal-stack.io/stable/installation/troubleshoot.html#asn-not-unique",
	}
	IssueBMCWithoutMAC = Issue{
		ShortName:   "bmc-without-mac",
		Description: "BMC has no mac address",
		RefURL:      "https://docs.metal-stack.io/stable/installation/troubleshoot.html#bmc-without-mac",
	}
	IssueBMCWithoutIP = Issue{
		ShortName:   "bmc-without-ip",
		Description: "BMC has no ip address",
		RefURL:      "https://docs.metal-stack.io/stable/installation/troubleshoot.html#bmc-without-ip",
	}
	IssueNonDistinctBMCIP = Issue{
		ShortName:   "bmc-no-distinct-ip",
		Description: "BMC IP address is not distinct",
		RefURL:      "https://docs.metal-stack.io/stable/installation/troubleshoot.html#bmc-no-distinct-ip",
	}
